...
export class WhaleProfiler {
  ...
  inferCategory(trade: WhaleTrade): string {
    ...
    if (/nfl|nba|mlb|nhl|ncaa|soccer|football|baseball|basketball|tennis|ufc|mma|win on 20|match|game\b|league|championship|playoffs|bowl\b|series\b|vs\.|spread:|o\/u \d|over\/under|moneyline|parlay|falcons|eagles|warriors|cavaliers|lakers|celtics|patriots|cowboys|yankees|dodgers|red sox|wolfpack|crusaders|terriers|minutemen|cardinals|hawks|hornets|panthers|tigers|bears|lions|bulls|colts|rams|ravens|steelers|chiefs|packers|broncos|49ers|saints|buccaneers|chargers|bengals|jaguars|titans|texans|raiders|seahawks|commanders|giants|jets|dolphins|bills|clippers|nets|knicks|heat|spurs|suns|nuggets|grizzlies|pelicans|blazers|rockets|mavericks|timberwolves|thunder|magic|pistons|raptors|wizards|royals|astros|braves|brewers|cubs|diamondbacks|guardians|mariners|marlins|mets|nationals|orioles|padres|phillies|pirates|reds|rockies|twins|white sox|athletics|blue jays|rays|\bfc\b|united fc|city fc|real madrid|barcelona|juventus|bayern|dortmund|napoli|inter milan|ac milan|arsenal|chelsea|liverpool|tottenham|everton|burnley|southampton|newcastle|wolverhampton|aston villa|derby county|sheffield|leicester|brighton|crystal palace|bournemouth|west ham|fulham|brentford|nottingham|luton|manchester|borussia|atletico|sevilla|valencia|villarreal|ajax|psv|feyenoord|porto|benfica|sporting|celtic|rangers|marseille|lyon|monaco|psg|paris saint|ligue 1|la liga|serie a|bundesliga|premier league|eredivisie|primera|copa |mexican open|french open|wimbledon|us open|australian open|atp |wta |grand slam|games total/.test(text)) {
      return "sports";
    }
